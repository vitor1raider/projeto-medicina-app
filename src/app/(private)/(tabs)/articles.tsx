    ...
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.content}>
        ...
        {!loading && articles.length === 0 && (
          <Text style={styles.emptyText}>Nenhum artigo disponível no momento.</Text>
        )}
          ...
          {articles.map((article) => (
            ...
            >
              {article.cover_image_url ? (
                <Image source={{ uri: article.cover_image_url }} style={styles.cardImage} />
              ) : (
            ...
            {selectedArticle && (
              <>
                ...
                <View style={styles.modalTextArea}>
                  <ArticleContent html={buildArticleHtml(selectedArticle.content)} />
                </View>

                <TouchableOpacity style={styles.closeButton} onPress={handleCloseArticle}>
