...
const healthTopics: HealthTopic[] = [
  {
    ...
    description:
      "Entenda fases do ciclo, sintomas comuns e alterações que merecem atenção.",
    icon: "🌙",
    content: [
  ...
  },
  {
    ...
    description:
      "Informações sobre dor menstrual e quando procurar orientação.",
    icon: "🌸",
    content: [
  ...
  },
  {
    ...
    description:
      "Conheça opções contraceptivas e a importância da orientação profissional.",
    icon: "🛡️",
    content: [
                ...
                <ScrollView style={styles.modalTextArea}>
                  ...
                  <View style={styles.warningBox}>
                    <Text style={styles.warningText}>
                      Este conteúdo é apenas informativo e não substitui a
